...
\newline
	\begin{figure}[H]
		\centering
<<fig=TRUE, echo=FALSE>>=
dat.HOA.y<-subset(dat.HOA1,dat.HOA$HOA==1) 
dat.HOA.n<-subset(dat.HOA1,dat.HOA$HOA==2)
...
p2<-ggplot(data=ggdat.recycle,aes(x=Recycle,y=Freq, fill=HOA))+
    ...
    theme_bw()+
    geom_hline(yintercept = 0)+
  scale_x_discrete(labels = c("0" = "No Curbside Pickup", "1" = "Only Trash" , "2"="Both Recycling and Trash"))
p2
...
\begin{figure}[H]
		\centering
<<fig=TRUE,echo=FALSE>>=
ggdat.r<-data.frame(dat.HOA$Recycle,dat.HOA$Neighborhood,dat.HOA$HOA)
names(ggdat.r)<-c("Recycle","Neighborhood", "HOA")
#ggdat.r.lc$HOA<-factor(ggdat.r.lc$HOA,levels = c(1,2),labels = c("HOA", "No HOA"))

p2<-ggplot(data=ggdat.r, aes(x=Recycle, y=Neighborhood, 
                                #shape=Neighborhood, 
                                color=HOA)) +
  #geom_jitter()+
  ...
  xlab("Recycling Status")+
  ylab("Neighborhood")+
  ggtitle("Relationship between Neighborhood and Recycling")+
...
\begin{figure}[H]
		\centering
<<fig=TRUE,echo=FALSE>>=
ggdat.lc<-data.frame(dat.HOA$LawnCare,dat.HOA$Neighborhood,dat.HOA$HOA)
names(ggdat.lc)<-c("LawnCare","Neighborhood", "HOA")
#ggdat.r.lc$HOA<-factor(ggdat.r.lc$HOA,levels = c(1,2),labels = c("HOA", "No HOA"))

p2<-ggplot(data=ggdat.lc, aes(x=LawnCare, y=Neighborhood, 
                                #shape=Neighborhood, 
                                color=HOA)) +
  #geom_jitter()+
  #geom_smooth(method=lm,se=FALSE,fullrange=TRUE)+
  ...
  ylab("Neighborhood")+
  ggtitle("Relationship between Neighborhood and Lawn Care")+
  #scale_x_discrete(labels=c("1"="Excellent", "2"="Good", "3"="Poor", "4"="None"))+
  #scale_y_discrete(labels=c("0" = "No Curbside Pickup", "1" = "Trash and Recycling", "2" = "Only Trash Pickup"))+
  theme_bw()
p2
...
\begin{figure}[H]
		\centering
<<fig=TRUE,echo=FALSE>>=
ggdat.t<-data.frame(dat.HOA$Trees,dat.HOA$Neighborhood,dat.HOA$HOA)
names(ggdat.t)<-c("Trees","Neighborhood", "HOA")
#ggdat.r.lc$HOA<-factor(ggdat.r.lc$HOA,levels = c(1,2),labels = c("HOA", "No HOA"))

p2<-ggplot(data=ggdat.t, aes(x=Trees, y=Neighborhood, 
                                #shape=Neighborhood, 
                                color=HOA)) +
  #geom_jitter()+
  #geom_smooth(method=lm,se=FALSE,fullrange=TRUE)+
  ...
  xlab("Trees")+
  ylab("Neighborhood")+
  ggtitle("Relationship between Neighborhood and Trees")+
  #scale_x_discrete(labels=c("1"="Excellent", "2"="Good", "3"="Poor", "4"="None"))+
  #scale_y_discrete(labels=c("0" = "No Curbside Pickup", "1" = "Trash and Recycling", "2" = "Only Trash Pickup"))+
  theme_bw()
p2
...
<<fig=TRUE, echo=FALSE>>=
library("qqplotr")
ggdat<-data.frame(HOA=as.numeric(dat.HOA.notree$HOA), Trees=as.numeric(dat.HOA.notree$Trees))
...
\begin{figure}[H]
		\centering
<<fig=TRUE,echo=FALSE>>=
ggdat.g<-data.frame(dat.HOA$Garden,dat.HOA$Neighborhood,dat.HOA$HOA)
names(ggdat.g)<-c("Garden","Neighborhood", "HOA")
#ggdat.r.lc$HOA<-factor(ggdat.r.lc$HOA,levels = c(1,2),labels = c("HOA", "No HOA"))

p2<-ggplot(data=ggdat.g, aes(x=Garden, y=Neighborhood, 
                                #shape=Neighborhood, 
                                color=HOA)) +
  #geom_jitter()+
  #geom_smooth(method=lm,se=FALSE,fullrange=TRUE)+
  ...
  xlab("Garden Status")+
  ylab("Neighborhood")+
  ggtitle("Relationship between Neighborhood and Garden Status")+
  #scale_x_discrete(labels=c("1"="Excellent", "2"="Good", "3"="Poor", "4"="None"))+
  #scale_y_discrete(labels=c("0" = "No Curbside Pickup", "1" = "Trash and Recycling", "2" = "Only Trash Pickup"))+
  theme_bw()
p2
...
p2<-ggplot(data=ggdat.r.lc, aes(x=LawnCare, y=Recycle, 
  ...
  ggtitle("Correlation between Lawn Care and Recycling by HOA")+
  #scale_x_discrete(labels=c("1"="Excellent", "2"="Good", "3"="Poor", "4"="None"))+
  #scale_y_discrete(labels=c("0" = "No Curbside Pickup", "1" = "Trash and Recycling", "2" = "Only Trash Pickup"))+
  theme_bw()
p2
...
p2<-ggplot(data=ggdat.r.t, aes(x=Recycle, y=Trees, 
  ...
  xlab("Recycling Status")+
  ggtitle("Correlation between Number of Trees and Recycling by HOA")+
...
<<fig=TRUE, echo=FALSE>>=
library("qqplotr")
ggdat<-data.frame(Recycle=as.numeric(dat.HOA.notree.y$Recycle), Trees=as.numeric(dat.HOA.notree.y$Trees))
ggplot(data=ggdat,aes(sample=Trees))+
  stat_qq_band(alpha=0.25) +
  stat_qq_line()+
  stat_qq_point()+
  ...
  xlab("Gaussian Quantiles")+
  ylab("Sample Quantiles")+
  ggtitle("Normality for HOA Households")+
  facet_grid(. ~ Recycle)
@
		\label{Fig:plot13}
	\end{figure}
...
<<fig=TRUE, echo=FALSE>>=
library("qqplotr")
ggdat<-data.frame(Recycle=as.numeric(dat.HOA.notree.n$Recycle), Trees=as.numeric(dat.HOA.notree.n$Trees))
ggplot(data=ggdat,aes(sample=Trees))+
  stat_qq_band(alpha=0.25) +
  stat_qq_line()+
  stat_qq_point()+
  ...
  xlab("Gaussian Quantiles")+
  ylab("Sample Quantiles")+
  ggtitle("Normality for non HOA Households")+
  facet_grid(. ~ Recycle)
@
		\label{Fig:plot14}
	\end{figure}
...
p2<-ggplot(data=ggdat.lc.t, aes(x=LawnCare, y=Trees, 
  ...
  ylab("Number of Trees in Yard")+
  xlab("Lawn Care Status")+
  ggtitle("Correlation between Number of Trees and Lawn Care Status by HOA")+
  #scale_x_discrete(labels=c("1"="Excellent", "2"="Good", "3"="Poor", "4"="None"))+
  theme_bw()
p2
@
...
<<fig=TRUE, echo=FALSE>>=
library("qqplotr")
ggdat<-data.frame(LawnCare=as.numeric(dat.HOA.notree.y$LawnCare), Trees=as.numeric(dat.HOA.notree.y$Trees))
ggplot(data=ggdat,aes(sample=Trees))+
  stat_qq_band(alpha=0.25) +
  stat_qq_line()+
  stat_qq_point()+
...
<<fig=TRUE, echo=FALSE>>=
library("qqplotr")
ggdat<-data.frame(LawnCare=as.numeric(dat.HOA.notree.n$LawnCare), Trees=as.numeric(dat.HOA.notree.n$Trees))
ggplot(data=ggdat,aes(sample=Trees))+
  stat_qq_band(alpha=0.25) +
  stat_qq_line()+
  stat_qq_point()+
