...
<<fig=TRUE,echo=FALSE>>=
#  ggdat<-data.frame(x=dat.HOA1$HOA,)
#  ggplot(ggdat,aes(x=x,y=..count..))+
#    geom_bar(stat="identity")
 barplot(prop.table(table(dat.HOA1$HOA)),
  xlab="HOA Status",
...
<<fig=TRUE,echo=FALSE>>=
ggdat.r.lc<-data.frame(dat.HOA1$Recycle,dat.HOA1$LawnCare,dat.HOA1$Neighborhood,dat.HOA1$HOA)
names(ggdat.r.lc)<-c("Recycle", "LawnCare", "Neighborhood", "HOA")
ggdat.r.lc$HOA<-factor(ggdat.r.lc$HOA,
                       levels = c(1,2),
                       labels = c("HOA", "No HOA"))
...
<<fig=TRUE,echo=FALSE>>=
ggdat.r.g<-data.frame(dat.HOA1$Recycle,dat.HOA1$Garden,dat.HOA1$Neighborhood,dat.HOA1$HOA)
names(ggdat.r.g)<-c("Recycle", "Garden", "Neighborhood", "HOA")
ggdat.r.g$HOA<-factor(ggdat.r.g$HOA,
                       levels = c(1,2),
                       labels = c("HOA", "No HOA"))
...
<<fig=TRUE,echo=FALSE>>=
ggdat.r.t<-data.frame(dat.HOA1$Recycle,dat.HOA1$Trees,dat.HOA1$Neighborhood,dat.HOA1$HOA)
names(ggdat.r.t)<-c("Recycle", "Trees", "Neighborhood", "HOA")
ggdat.r.t$HOA<-factor(ggdat.r.t$HOA,
                       levels = c(1,2),
                       labels = c("HOA", "No HOA"))
...
<<fig=TRUE,echo=FALSE>>=
ggdat.lc.g<-data.frame(dat.HOA1$LawnCare,dat.HOA1$Garden,dat.HOA1$Neighborhood,dat.HOA1$HOA)
names(ggdat.lc.g)<-c("LawnCare", "Garden", "Neighborhood", "HOA")
ggdat.lc.g$HOA<-factor(ggdat.lc.g$HOA,
                       levels = c(1,2),
                       labels = c("HOA", "No HOA"))
...
<<fig=TRUE,echo=FALSE>>=
ggdat.lc.t<-data.frame(dat.HOA1$LawnCare,dat.HOA1$Trees,dat.HOA1$Neighborhood,dat.HOA1$HOA)
names(ggdat.lc.t)<-c("LawnCare", "Trees", "Neighborhood", "HOA")
ggdat.lc.t$HOA<-factor(ggdat.lc.t$HOA,
                       levels = c(1,2),
                       labels = c("HOA", "No HOA"))
...
<<fig=TRUE,echo=FALSE>>=
ggdat.g.t<-data.frame(dat.HOA1$Garden,dat.HOA1$Trees,dat.HOA1$Neighborhood,dat.HOA1$HOA)
names(ggdat.g.t)<-c("Garden", "Trees", "Neighborhood", "HOA")
ggdat.g.t$HOA<-factor(ggdat.g.t$HOA,
                       levels = c(1,2),
                       labels = c("HOA", "No HOA"))
ggdat.g.t$Garden<-factor(ggdat.g.t$Garden,
                       levels = c(1,2),
                       labels = c("Yes", "No"))
